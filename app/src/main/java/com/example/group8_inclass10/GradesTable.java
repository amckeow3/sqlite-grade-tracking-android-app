...
public class GradesTable {
    ...
    static final String COLUMN_CREDIT_HOURS = "credit_hours";
    static final String COLUMN_GRADE = "grade";
    static final String COLUMN_GRADE_POINTS = "grade_points";
    ...
    static public void onCreate(SQLiteDatabase db) {
        ...
        sb.append("CREATE_TABLE " + GradesTable.TABLE_NAME + " (");
        sb.append(COLUMN_ID + " integer primary key autoincrement, ");
        sb.append(COLUMN_COURSE + " text not null, ");
        sb.append(COLUMN_CREDIT_HOURS + " integer not null");
        sb.append(COLUMN_GRADE + " text not null, ");
        sb.append(COLUMN_GRADE_POINTS + " integer not null);");
